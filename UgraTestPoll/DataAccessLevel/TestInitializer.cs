...
namespace UgraTestPoll.DataAccessLevel
{
    ...
    public class TestInitializer : System.Data.Entity.DropCreateDatabaseIfModelChanges<PollContext>
    {
        protected override void Seed(PollContext context)
        {
            ...
            new CheckBoxAnswer{AnswerText="void Clazz(String name)", Active=true, Correct=true, QuestionID=questions[1].ID},
            ...
            /* C# */
            new RadionAnswer{AnswerText="Да", Active=true, Correct=true, QuestionID=questions[5].ID},
            new RadionAnswer{AnswerText="Нет, но возможна реализация нескольких интерфейсов", Active=true, Correct=false, QuestionID=questions[5].ID},
